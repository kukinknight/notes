...
app.get('/user/list',function(req,res){
    ...
    fs.readFile("./studentlist.html",'utf-8',function(error,data){
        //查询数据库里面的数据
        client.query('select * from sty',function(err,result){
            //利用ejs模块来传输入
...
app.get('/edit/:id',function(req,res){
    fs.readFile('./edit.html','utf-8',function(err,data){
        //执行sql
        var userAddSql1 =   'SELECT * FROM sty WHERE stuid = ?'
...
//修改值
 app.post('/edit/:id',function(req,res){
    ...
    var userAddSq2 = 'UPDATE sty SET stuname = ?,stuaddress = ?,stuage =?,stusex = ? WHERE stuid = ?'
    var userAddSql_Params2 = [body.stuname,body.stuaddress,body.stuage,body.stusex,ID]
...
app.post('/addstu',function(req,res){
    var body = req.body
    console.log(body)
    var userAddSql = 'INSERT INTO sty(stuid,stuname,stuaddress,stuage,stusex) VALUES(?,?,?,?,?)'
    var userAddSql_Params = [body.stuid,body.stuname,body.stuaddress,body.stuage,body.stusex]
